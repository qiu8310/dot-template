...
export declare class Source {
     ...
     */
    private findMatchedUserTemplate(dtplFolder, configFile, isTemplateDirectory, config);
    /**
     * 加载配置文件，每次都重新加载，确保无缓存
     */
    private loadDtplConfig(configFile);
    /**
     * 在 dtpl 目录内找到配置文件
     */
    private findConfigFileInDtplFolder(dtplFolder);
    /**
